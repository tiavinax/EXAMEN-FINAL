        ...
        <div class="content-wrapper">
            ...
            <div class="form-card">
                ...
                <div class="form-card-body">
                    ...
                    <form action="/ETU003955/EXAMEN-FINAL/public/villes/update/<?= $ville->id ?>" method="POST" class="custom-form">
                        <!-- Nom de la ville -->
                        ...
                        <div class="form-actions">
                            <a href="/ETU003955/EXAMEN-FINAL/public/villes/liste" class="btn-outline">
